        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main>
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
                    {{-- Notifikasi Sukses --}}
                    @if (session('success'))
                        <div class="bg-green-500 text-white p-4 rounded-xl shadow-lg mb-4 flex items-center transition animate-pulse">
                    ...
                    @if (session('error'))
                        <div class="bg-red-500 text-white p-4 rounded-xl shadow-lg mb-4 flex items-center">
